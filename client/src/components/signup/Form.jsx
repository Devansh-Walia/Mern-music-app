  ...
  return (
    <div className="form">
      ...
      <form action="" autoComplete="off">
        ...
        {showmess1 && EmailError === "YES" && (
          <Errormessage message="Enter a Valid Email" />
        )}
        {showmess1 && EmailError === "NO" && (
        ...
        <Fade right>
          <div className="inputField">
            <input
              ...
              onChange={(e) => {
                setUserPassword({ ...passObj, userPassword: e.target.value });
              }}
            />
          </div>
        </Fade>
        <Fade bottom>
          <div className="inputField">
            <input
              ...
              onChange={(e) => {
                setUserPassword({ ...passObj, userPassword2: e.target.value });
                setshowmess(true);
              }}
            />
          </div>
        </Fade>
        {showmess && passmatch === "NO" && (
          <Errormessage message={"Passwords Do Not Match"} />
        )}
        {showmess && passmatch === "YES" && (
